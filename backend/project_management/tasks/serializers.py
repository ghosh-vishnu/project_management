...
class ProjectMiniSerializer(serializers.ModelSerializer):
    """Mini serializer for project in task list"""
    class Meta:
        model = Project
        fields = ['id', 'title']
...
class EmployeeMiniSerializer(serializers.ModelSerializer):
    """Mini serializer for employee in task list"""
...
class TaskListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Task
        fields = [
            'id', 'task_name', 'project_name', 'assign_to', 
...
class TaskCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Task
        fields = [
            'id', 'task_name', 'project_name_id', 'assign_to_id',
    ...
    def validate(self, attrs):
        ...
        if priority_value is not None:
            ...
            valid_values = [choice[0] for choice in Task.PRIORITY_CHOICES]
            if normalized not in valid_values:
                raise serializers.ValidationError({
